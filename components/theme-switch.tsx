...
export default function ThemeSwitch() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="fixed left-4 bottom-4 p-3 rounded-full bg-white dark:bg-gray-800 shadow-lg ring-1 ring-gray-200 dark:ring-gray-700 transition-all duration-200 hover:scale-110"
